                        ...
                        <div class="inner-content">
                            ...
                            <ul>
                                <li>
                                    <div class="right">
                                        <div class="text">
                                            <p>На платформе благотворительного онлайн-проекта «На здоровье!» вас ждут ответы на самые важные вопросы: о здоровье, о возрастных особенностях детей и родителей, о способах психологической и государственной поддержки детей и их родителей.</p>
                                ...
                                <li class="style2">
                                    <div class="right">
                                        <div class="text">
                                            <p>Наши спикеры – опытные психологи, врачи, юристы, депутаты, социальные работники, отвечающие за поддержку материнства и детства. Эксперты ответят на важные вопросы в текстовом и видео формате.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="style2">
